            ...
            return SingleChildScrollView(
              child: Column(
                children: [
                    ...
                    children: [
                      ...
                      Positioned(
                        ...
                        child: Center(
                          child: CircleAvatar(
                            radius: 40,
                            backgroundImage: controller.authController.currentUser?.profileImage != null
                              ? NetworkImage(controller.authController.currentUser!.profileImage!)
                                : null,
                            backgroundColor: Colors.grey[800],
                            child: controller.authController.currentUser?.profileImage == null
                  ...
                  // Name
                  Text(
                    controller.authController.currentUser?.name ?? 'Name',
                  ...
                  Row(
                    ...
                    children: [
                      Column(
                        children: [
                          Text(
                            '${controller.authController.currentUser?.followers ?? 0} Followers',
                            style: GoogleFonts.openSans(
                      ...
                      Column(
                        children: [
                          Text(
                            '${controller.authController.currentUser?.following ?? 0} Following',
                            style: GoogleFonts.openSans(
                              color: Colors.grey[400],
                              fontSize: 14,
                            ),
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: _buildStatItem(
                            '${controller.authController.currentUser?.reviews ?? 0}',
                            'Review',
                            Color(0xFF9C4A8B)!,
                          ),
                        ),
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          "${controller.authController.currentUser?.name ?? 'User'}'s Favorite Films",
                          style: GoogleFonts.openSans(
                            fontSize: 18,
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            Text(
                              "${controller.authController.currentUser?.name ?? 'User'}'s Recent Watched",
                              style: GoogleFonts.openSans(
                                fontSize: 18,
                                fontWeight: FontWeight.w600,
                                color: Colors.white,
                        ...
                        SizedBox(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              final movie =
                                  controller.recentlyWatched[index];
                              return GestureDetector(
                                onTap: () {
                                  Get.toNamed(AppRoutes.movieDetailPath(
                                      movie.id.toString()));
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              Text(
                                "${controller.authController.currentUser?.name ?? 'User'}'s Recent Reviewed",
                                style: GoogleFonts.openSans(
                                  fontSize: 18,
                                  fontWeight: FontWeight.w600,
                                  color: Colors.white,
                          ...
                          ReviewCard(
                            ...
                            rating: (controller
                                ...
                                2,
                            content:
                                controller.recentlyWatched[0].overview,
                            commentCount: 0,
                            movieTitle:
                                controller.recentlyWatched[0].title,
                            movieYear: controller
                                .recentlyWatched[0].releaseDate
                                .split('-')[0],
                            moviePosterUrl:
                                controller.recentlyWatched[0].posterUrl,
                            onTap: () {
                              final movie = controller.recentlyWatched[0];
                              final reviewObj = Review(
                                ...
                                username: controller
                                        .authController.currentUser?.name ??
                                    'User',
                                userAvatarUrl: controller.authController
