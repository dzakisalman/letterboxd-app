...
class _ListCard extends StatelessWidget {
  ...
  const _ListCard(
      {required this.list, required this.userName, required this.userAvatar});
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  const SizedBox(width: 6),
                  const Icon(Icons.favorite, color: Color(0xFFE74C3C), size: 12),
                  ...
                  const SizedBox(width: 2),
                  Text('79', style: TextStyle(color: Colors.white.withOpacity(0.5), fontSize: 10)),
                ],
              ),
            ],
          ),
...
class MovieStackList extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final limitedPosters =
        posterUrls.length > 4 ? posterUrls.sublist(0, 4) : posterUrls;
    return SizedBox(
      height: 90,
      child: Stack(
